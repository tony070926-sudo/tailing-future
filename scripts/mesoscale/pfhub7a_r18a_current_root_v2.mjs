...
import { verifyAdmissionAtRoot, INTEGRATION_BASE, SCIENTIFIC_CONTRACT_BASE } from '../backend-migration/verify-r18a-origin-main-admission-v0.3.mjs';
...
export async function runCurrentRoot(args) {
  ...
  const evidence = { schemaVersion: 'tf.r18a-current-root-execution/0.3', scientificContractBaseCommit: '307e6d723086fe41b6d89e9f9b4b532364ccaeff', integrationBaseCommit: null, candidateTreeIdentity: null, sourceInputIdentity: null, startedAt: new Date(started).toISOString(), status: 'abstain', releaseEligible: false, historicalCandidateIdentityTransferred: false, convergenceVerified: false, physicalValidation: false, reproduced: false, scientificPromotionEligible: false, commands: [] };
  let runDirectory;
  try {
